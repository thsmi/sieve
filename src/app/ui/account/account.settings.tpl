<div>
  ...
  <hr>
  <h4>Danger Zone</h4>
  <div>Remove this account for the app. The server account will remain untouched, no scripts are deleted and the currently active
    remains active.</div>
  <button type="button" class="mt-3 sieve-account-delete-server btn btn-sm btn-outline-danger">Delete Account</button>
</div>