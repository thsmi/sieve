...
SieveMozilla.prototype = Object.create(Sieve.prototype);
SieveMozilla.prototype.constructor = SieveMozilla;  

 // Needed for the Gecko 2.0 Component Manager...
SieveMozilla.prototype.QueryInterface
  = function(aIID)
{
 ...
 * @return {Boolean}
 */
SieveMozilla.prototype.isAlive 
   = function()
{
 if (!Sieve.prototype.isAlive())
   return false;
 ...
 **/
SieveMozilla.prototype.startTLS 
   = function ( callback )
{
...
SieveMozilla.prototype._startTimeoutTimer
    = function () {
...
SieveMozilla.prototype._stopTimeoutTimer
    = function () {
...
SieveMozilla.prototype._startIdleTimer
    = function () {
...
SieveMozilla.prototype._stopIdleTimer
    = function () {
...
SieveMozilla.prototype.connect
 ...
 * @param {} aStatus
 */
SieveMozilla.prototype.onProxyAvailable
 ...
 * 
 */
SieveMozilla.prototype.disconnect
    = function () 
{ 
...
SieveMozilla.prototype.onStopRequest 
...
SieveMozilla.prototype.onStartRequest 
...
SieveMozilla.prototype.onDataAvailable 
    = function(aRequest, context, inputStream, offset, count)
{
  ...
  Sieve.prototype.onDataReceived(data)
}

Sieve.prototype._send
  = function(data)
{ 

  // Force String to UTF-8...
  output = this.bytesFromJSString(data);    
