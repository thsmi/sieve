...
(function (exports) {
  ...
  // TODO merge with wx and move to common...
  ...
  class SieveDeleteAccountDialog extends SieveDialog {
     ...
     */
    getTemplate() {
      return "./libs/managesieve.ui/dialogs/dialog.account.delete.tpl";
    }
  ...
  class SieveFingerprintDialog extends SieveDialog {
     ...
     */
    getTemplate() {
      return "./libs/managesieve.ui/dialogs/dialog.account.cert.tpl";
    }
  ...
  class SieveDeleteScriptDialog extends SieveDialog {
     ...
     */
    getTemplate() {
      return "./libs/managesieve.ui/dialogs/dialog.script.delete.tpl";
    }
  ...
  class SieveCreateScriptDialog extends SieveDialog {
     ...
     */
    getTemplate() {
      return "./libs/managesieve.ui/dialogs/dialog.script.create.tpl";
    }
  ...
  class SieveRenameScriptDialog extends SieveDialog {
     ...
     */
    getTemplate() {
      return "./libs/managesieve.ui/dialogs/dialog.script.rename.tpl";
    }
  ...
  class SievePasswordDialog extends SieveDialog {
     ...
     */
    getTemplate() {
      return "./libs/managesieve.ui/dialogs/dialog.account.password.tpl";
    }
  ...
  class SieveAuthorizationDialog extends SieveDialog {
     ...
     */
    getTemplate() {
      return "./libs/managesieve.ui/dialogs/dialog.account.authorization.tpl";
    }
  ...
  class SieveScriptBusyDialog extends SieveDialog {
     ...
     */
    getTemplate() {
      return "./libs/managesieve.ui/dialogs/dialog.script.busy.tpl";
    }
  ...
  class SieveScriptSaveDialog extends SieveDialog {
     ...
     */
    getTemplate() {
      return "./libs/managesieve.ui/dialogs/dialog.script.save.tpl";
    }
  ...
  class SieveErrorDialog extends SieveDialog {
     ...
     */
    getTemplate() {
      return "./libs/managesieve.ui/dialogs/dialog.error.tpl";
    }
