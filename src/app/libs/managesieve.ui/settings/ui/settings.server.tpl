<div>
  <div class="form-group row">
    ...
    <div class="col-sm-8">
      <input type="text" data-i18n="server.displayname.placeholder" class="sieve-settings-displayname form-control">
    </div>
  </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-8">
      <input type="text" data-i18n="server.fingerprint.placeholder" class="sieve-settings-fingerprint form-control">
    </div>
  </div>
