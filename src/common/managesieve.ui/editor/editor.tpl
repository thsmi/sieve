  ...
  <div class="card mt-4 mb-2">
    <div class="card-header d-flex justify-content-between py-0">
      <ul class="nav nav-tabs card-header-tabs my-0 pt-3" role="tablist">
        <li class="nav-item">
          <a class="nav-link" data-i18n="editor.script" data-toggle="tab" href="#sieve-widget-editor" role="tab"></a>
        </li>
        <li class="nav-item">
      ...
      <div class="align-self-center">
        <button data-i18n="editor.save" type="button" class="btn btn-sm btn-outline-secondary mr-1"
          id="sieve-editor-save">Save</button>
        ...
        <div id="sieve-editor-settings" class="btn-group dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuLink">
            ...
            <a data-i18n="editor.menu.reload" class="dropdown-item" href="javascript:window.location.reload(true)"></a>
