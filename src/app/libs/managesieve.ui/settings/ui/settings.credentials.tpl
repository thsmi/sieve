  ...
  <div class="col-sm-8">
    <div class="sieve-settings-authentication dropdown">
      ...
      <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
        <a class="dropdown-item" data-i18n="credentials.sasl.default" data-sieve-authentication="default" href="#"></a>
        ...
        <a class="dropdown-item" data-i18n="credentials.sasl.crammd5" data-sieve-authentication="CRAM-MD5" href="#"></a>
        <a class="dropdown-item" data-i18n="credentials.sasl.scramsha1" data-sieve-authentication="SCRAM-SHA-1" href="#"></a>
        <a class="dropdown-item" data-i18n="credentials.sasl.scramsha256" data-sieve-authentication="SCRAM-SHA-256" href="#"></a>
        <a class="dropdown-item" data-i18n="credentials.sasl.external" data-sieve-authentication="EXTERNAL" href="#"></a>
        <div class="dropdown-divider"></div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-8">
      <div class="sieve-settings-authorization dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
          <a data-i18n="credentials.authorization.implicit" class="dropdown-item" data-sieve-authorization="0" href="#"></a>
          <div class="dropdown-divider"></div>
          <a data-i18n="credentials.authorization.current" class="dropdown-item" data-sieve-authorization="1" href="#"></a>
          <a data-i18n="credentials.authorization.prompt" class="dropdown-item" data-sieve-authorization="2" href="#"></a>
          <a data-i18n="credentials.authorization.username" class="dropdown-item" data-sieve-authorization="3" href="#"></a>
        </div>
      </div>
    </div>
  </div>
